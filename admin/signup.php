...
$ret="SELECT * FROM tbladmin where (UserName=:uname ||  Email=:uemail)";
...
{
// Query for Insertion
$sql="INSERT INTO tbladmin(AdminName,UserName,MobileNumber,Email,Password) VALUES(:fname,:uname,:umobile,:uemail,:upassword)";
$query = $dbh->prepare($sql);
// Binding Post Values
$query->bindParam(':fname',$AdminName,PDO::PARAM_STR);
...
<head>
    <meta charset="utf-8">
    <title>M-Production Registration Page</title>
...
<?php if($msg){ ?><div class="succWrap">
 ...
 <div class="control-group">
      ...
      <div class="controls">
        ...
        <p class="help-block">Full Name must contain Letters only</p>
      </div>
    </div>
    <div class="control-group">
      <!-- Username -->
    ...
    <div class="control-group">
      ...
      <div class="controls">
       <br><p>Or Go </p> <a href="../index.php">Back Home</a>
      </div> 
    </div>
  </fieldset>
</form>
