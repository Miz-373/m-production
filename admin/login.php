...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>M-Production - Login Page</title>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="login.php">
                                        ...
                                        <span class="font-size-xl">M-Production</span>
                                    </a>
                                ...
                                <form class="js-validation-signin px-30" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p style="margin-top: 50px;">Want To Be Staff? Then <a href="signup.php">Sign Up here</a></p>
                                        <p>Or</p><a href="../index.php">Back Home!!</a>
                                    </div>
                                </form>
                                <!-- END Sign In Form -->
                            </div>
