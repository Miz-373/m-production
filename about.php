...
<html>
<head>
<title>M-Production || About Us</title>
...
{               ?>
		 ...
		 <div class="latest">
			 ...
			 <div class="pic start">
				 ...
				 <h4><a href="event.html">Live DJ</a></h4>
			 ...
			 <div class="pic">
				 ...
				 <h4><a href="event.html">Rock Bands</a></h4>
				 <p>Suspendisse posuere enim eu ante scelerisque, vehicula turpis.</p>
			 </div>
			 <div class="pic">
				 ...
				 <h4><a href="event.html">Karaoke</a></h4>
				 <p>Suspendisse posuere enim eu ante scelerisque, vehicula turpis.</p>
			 </div>
			 <div class="pic">
				 ...
				 <h4><a href="event.html">Instruments</a></h4>
				 <p>Suspendisse posuere enim eu ante scelerisque, vehicula turpis.</p>
			 </div>
			 <div class="pic">
				 ...
				 <h4><a href="event.html">Lighting System</a></h4>
				 <p>Suspendisse posuere enim eu ante scelerisque, vehicula turpis.</p>
			 </div>
			 <div class="clearfix"></div>
		 </div>
